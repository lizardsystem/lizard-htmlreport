...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('lizard_htmlreport_reporttemplate', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=255)),
        ))
        db.send_create_signal('lizard_htmlreport', ['ReportTemplate'])

        # Adding model 'GeneratedReport'
        db.create_table('lizard_htmlreport_generatedreport', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ...
            ('template', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['lizard_htmlreport.ReportTemplate'])),
        ...
        db.send_create_signal('lizard_htmlreport', ['GeneratedReport'])


    def backwards(self, orm):
        
        # Deleting model 'ReportTemplate'
        db.delete_table('lizard_htmlreport_reporttemplate')

        # Deleting model 'GeneratedReport'
        db.delete_table('lizard_htmlreport_generatedreport')
